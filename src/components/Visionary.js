        ...
        >
            ...
            <div ref={contentRef} className="flex flex-col justify-center space-y-8">
                ...
                <div className="font-sans text-gray-400 text-lg leading-relaxed max-w-xl space-y-6">
                    ...
                    <p>
  Our expertise now spans across high-value residential townships,
  commercial hubs, and strategic industrial corridors. At Sanyam RealTech, we follow
  the ARCHITAAA Principle —
  <span className="text-white font-semibold">A</span>dvanced{" "}
  <span className="text-white font-semibold">R</span>esearch,{" "}
  <span className="text-white font-semibold">C</span>lient{" "}
  <span className="text-white font-semibold">H</span>andling,{" "}
  <span className="text-white font-semibold">I</span>nvestment{" "}
  <span className="text-white font-semibold">T</span>ransparency,{" "}
  Trend{" "}
  <span className="text-white font-semibold">A</span>nalysis &{" "}
  <span className="text-white font-semibold">A</span>sset{" "}
  <span className="text-white font-semibold">A</span>dvantage Architecture.
</p>
